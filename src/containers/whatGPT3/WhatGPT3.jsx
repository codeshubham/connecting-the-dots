...
const WhatGPT3 = () => (
  <div className="gpt3__whatgpt3 section__margin" id="wgpt3">
    ...
    <div className="gpt3__whatgpt3-container">
      ...
      <Feature title="Welder" text="We also provide welder facilities through experienced workers. " />
